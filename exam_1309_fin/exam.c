...
int main(int argc,char* argv[])
{
	...
	switch(argc){
		case 1:
			...
			break;
		/*case 2:
			num_produttori_1 = atoi(argv[1]);
			num_produttori_2 = num_produttori_1;
			break;
		case 3:
			num_produttori_1 = atoi(argv[1]);
			num_produttori_2 = atoi(argv[2]);
			break;*/
		default:
			printf("Il programma non ha comandi in ingresso...\n");
			break;
	}
	...
	//int numero_consumazioni = (num_produttori_1*numero_produzioni_1) + (num_produttori_2*numero_produzioni_2);
